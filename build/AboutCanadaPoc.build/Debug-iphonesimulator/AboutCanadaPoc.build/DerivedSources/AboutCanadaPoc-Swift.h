...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AboutCanadaPoc",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14AboutCanadaPoc11AppDelegate")
...
SWIFT_CLASS("_TtC14AboutCanadaPoc26CountryDetailTableViewCell")
@interface CountryDetailTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageViewCountry;
...
SWIFT_CLASS("_TtC14AboutCanadaPoc14ViewController")
